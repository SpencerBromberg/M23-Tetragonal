import re, json, sympy as sp, math, time
...
if __name__ == '__main__':
    ...
    print('M23_TETRAGONAL_GLOBAL_IDENTITY_V95_BEGIN', flush=True)
    print('EVALUATION_RANGE = -485..485', flush=True)
    print('WEIGHTED_DEGREE_BOUND = 970', flush=True)
    st=time.time()
    procs=min(12, mp.cpu_count() or 1)
    ...
    print('M23_TETRAGONAL_GLOBAL_IDENTITY_V95_PASS', flush=True)
